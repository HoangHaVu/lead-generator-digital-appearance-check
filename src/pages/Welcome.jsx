      ...
      <main className="flex-1">
        ...
        <section className="bg-primary py-24 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10 flex flex-col gap-8 items-center">
            ...
            <button className="px-10 py-5 rounded-2xl bg-white text-primary text-xl font-black shadow-2xl hover:bg-slate-50 transition-all flex items-center gap-3 font-body">
